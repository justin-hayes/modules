...
public class TemplateControllerBundleIT extends BasePaxIT {
    ...
    public void verifyControllerFunctional() throws Exception {
        ...
        configService.updateConfigs(Arrays.asList(new Config("conf", false, null, null, ignoredStatusFields, null, "FROM:from", null, "ANS: NEW STATUS", null, false, null, false, null, false, null)));
